...
|----------|---------------------------------------------------------------------------------------------------|----------|
| AUTH-001 | As a user, I can sign in with Google OAuth so that I can access the platform quickly              | P0       |
...
| ID        | User Story                                                                                                       | Priority |
|-----------|------------------------------------------------------------------------------------------------------------------|----------|
| MODEL-001 | As a user, I can create an attribute model with a name and description so that I can define what data to extract | P0       |
| MODEL-002 | As a user, I can add string attributes to a model so that I can extract text fields                              | P0       |
...
| MODEL-006 | As a user, I can add array-of-strings attributes so that I can extract multiple values                           | P0       |
| MODEL-007 | As a user, I can add nested object attributes so that I can extract complex structures                           | P1       |
...
| MODEL-010 | As a user, I can add AI hints to attributes so that the LLM has better context                                   | P1       |
...
| MODEL-013 | As a user, I can add description/help text to attributes so that their purpose is clear                          | P2       |
...
| ID      | User Story                                                                                   | Priority |
|---------|----------------------------------------------------------------------------------------------|----------|
| VER-001 | As a user, I can create a new version of a model so that I can evolve schemas safely         | P0       |
| VER-002 | As a user, I can see the version history of a model so that I can track changes              | P0       |
| VER-003 | As a user, I can compare two versions of a model so that I can see what changed              | P1       |
| VER-004 | As a user, I can set a version as "active" so that extractions use the correct schema        | P1       |
...
| ID          | User Story                                                                                          | Priority |
|-------------|-----------------------------------------------------------------------------------------------------|----------|
| SRC-DOC-001 | As a user, I can upload a PDF document so that I can extract data from it                           | P0       |
...
| SRC-DOC-006 | As a user, I can upload documents via drag-and-drop so that the experience is intuitive             | P1       |
...
| ID          | User Story                                                                                   | Priority |
|-------------|----------------------------------------------------------------------------------------------|----------|
| SRC-IMG-001 | As a user, I can upload an image (PNG, JPG, WebP) so that I can extract data from it         | P0       |
...
| SRC-IMG-005 | As a user, I can extract text via OCR from images so that I process scanned documents        | P1       |
| SRC-IMG-006 | As a user, I can use vision models to understand image content so that I extract visual data | P1       |
...
| ID      | User Story                                                                                                 | Priority |
|---------|------------------------------------------------------------------------------------------------------------|----------|
| EXT-001 | As a user, I can run an extraction with a model + source so that I get structured data                     | P0       |
| EXT-002 | As a user, I can see the extraction result in a structured view so that I can review it                    | P0       |
| EXT-003 | As a user, I can edit extraction results before saving so that I can fix errors                            | P1       |
| EXT-004 | As a user, I can see extraction confidence scores so that I know data reliability                          | P1       |
...
| EXT-009 | As a user, I can see token usage per extraction so that I monitor costs                                    | P1       |
